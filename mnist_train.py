...
from models.set_autoencoder import TransformerSetAutoEncoder
...
class TspnAutoencoder:
    def __init__(self, load_step, config, dataset):
        ...
        self.tspn = TransformerSetAutoEncoder(self._c.encoder_latent, self._c.trans_layers, self._c.trans_attn_size, self._c.trans_num_heads,
                         self.dataset.element_size, self._c.size_pred_width, self._c.pad_value, self.dataset.max_num_elements)
        self.tspn.compile()

        self.tspn_optimiser = OneCycleAdamW(self._c.tspn_learning_rate, config.weight_decay, 200000)
